...
```json
{
  ...
  "data": {
    ...
    "download_files": {
      "csv": "data/sales_trend_20260425.csv",
      "excel": "data/sales_trend_20260425.xlsx",
      "json": "data/sales_trend_20260425.json"
    }
  },
  "metadata": {
    "format": "html",
...
- connectors/tool/csv_connector - CSV导出
- connectors/tool/excel_connector - Excel导出
